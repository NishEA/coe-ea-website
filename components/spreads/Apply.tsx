    ...
    >
      ...
      <div className="mb-16 grid grid-cols-1 items-end gap-8 tablet:mb-20 tablet:grid-cols-12">
        ...
        <p className="font-body text-[17px] leading-[1.6] text-brand-navy/70 tablet:col-span-4 tablet:text-right">
          Equity-based engagement — the Centre takes 1–3% equity on signing.
          Onboarding completes only after the equity agreement is executed.
          Applications reviewed on a rolling basis; shortlisted founders
