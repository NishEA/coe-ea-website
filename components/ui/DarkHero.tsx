...
export function DarkHero({
  ...
  return (
    ...
    >
      ...
      >
        <p
          className="fade-up font-mono text-[12px] uppercase tracking-[0.22em] text-brand-cerulean"
          style={{ animationDelay: '0.05s' }}
        >
          {label}
        </p>
        <h1
          className="fade-up mt-5 max-w-2xl font-display font-bold leading-[1.04] tracking-[-0.025em] text-white text-[clamp(44px,5.5vw,72px)]"
